...
//#endif
	...
	GLuint texID3 = generateTexture("../textures/dinoSolo1.png");
	GLuint texID4 = generateTexture("../textures/dinoSolo2.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Desenho do sprite do dinosauro 1
		//Atualiza a matriz de modelo (transform do objeto)
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(140, 133, 0));
		model = glm::scale(model, glm::vec3(70.0f, 70.0f, 1.0f));
		shader.setMat4("model", glm::value_ptr(model));
		//Chamada de desenho
		...
		//Desenho do sprite do dinosauro 2
		//Atualiza a matriz de modelo (transform do objeto)
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(600, 400, 0));
		model = glm::scale(model, glm::vec3(70.0f, 70.0f, 1.0f));
		shader.setMat4("model", glm::value_ptr(model));
		//Chamada de desenho
		...
		//Desenho do sprite do dinosauro 3
		//Atualiza a matriz de modelo (transform do objeto)
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(100, 500, 0));
		model = glm::scale(model, glm::vec3(70.0f, 70.0f, 1.0f));
		shader.setMat4("model", glm::value_ptr(model));
		//Chamada de desenho
		glBindTexture(GL_TEXTURE_2D, texID4); //conecta a textura desejada
		...
		//Desenho do sprite do dinosauro 4
		//Atualiza a matriz de modelo (transform do objeto)
		model = glm::mat4(1); //matriz identidade
		model = glm::translate(model, glm::vec3(500, 133, 0));
		model = glm::scale(model, glm::vec3(70.0f, 70.0f, 1.0f));
		shader.setMat4("model", glm::value_ptr(model));
		//Chamada de desenho
		glBindTexture(GL_TEXTURE_2D, texID3); //conecta a textura desejada
