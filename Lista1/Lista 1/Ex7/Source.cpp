...
//#endif
	...
	GLuint VAO = createCircle(0.2, 200);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_LINE_STRIP, 0, 202);
...
int createCircle(float radius, int nPoints)
{
	...
	//totalSize = Quantidade de floats que usaremos para alocar nPoints + 1 vertices.
	...
	float angle = 0.0;
	float slice = 6 * pi / (float)nPoints;
