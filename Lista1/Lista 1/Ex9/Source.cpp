...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glClearColor(0.196078f, 0.6f, 0.9f, 1.0f); //cor de fundo
		...
		glUniform4f(colorLoc, 255.0f, 255.0f, 255.0f, 1.0f); //enviando cor para variável uniform inputColor		
		...
		glUniform4f(colorLoc, 0.52f, 0.37f, 0.26f, 1.0f); //enviando cor para variável uniform inputColor		
		glDrawArrays(GL_TRIANGLES, 9, 3);

		glUniform4f(colorLoc, 0.52f, 0.37f, 0.26f, 1.0f); //enviando cor para variável uniform inputColor		
		glDrawArrays(GL_TRIANGLES, 12, 3);

		glUniform4f(colorLoc, 0.0f, 0.5f, 0.0f, 1.0f); //enviando cor para variável uniform inputColor		
